            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="w-50">
                    <div class="row">
                        ...
                        <div class="col-4 d-flex justify-content-end"><button class="btn btn-success" data-toggle="modal" data-target="#modal">{{ __('lang.CreateNew') }}</button></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function refresh()
    {
        ...
        window.open("{{url('/expense/')}}/"+from+"/"+to, "_self");
    }
</script>
@endsection
